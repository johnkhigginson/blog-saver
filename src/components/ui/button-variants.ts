...
// Kept in a non-"use client" module so both Server and Client Components can
// compute button classes (e.g. to style a <Link> like a button). Importing this
// from the client Button component would make it a client-only reference.
